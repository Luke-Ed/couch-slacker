...
package com.github.luke_ed.couchdb.slacker.mapping;
...
import com.github.luke_ed.couchdb.slacker.TestDocument;
import com.github.luke_ed.couchdb.slacker.TestDocumentRepository;
...
@ContextConfiguration(
    classes = {MappingTestConfiguration.class, TestDocumentRepository.class},
    initializers = ConfigDataApplicationContextInitializer.class)
@ActiveProfiles("mapping-test")
@EntityScan({"com.github.luke_ed.couchdb.slacker"})
...
class MappingIntegrationTest {
  ...
  @Autowired TestDocumentRepository repository;
    ...
    context.doIn(
        ...
        () -> {
          assertEquals(
              0L,
              repository.count(),
              "Database " + databaseName + " should be empty in context " + contextName);
