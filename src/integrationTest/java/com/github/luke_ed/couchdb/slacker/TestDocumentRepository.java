...
public interface TestDocumentRepository
    extends PagingAndSortingRepository<TestDocument, String>, CrudRepository<TestDocument, String> {
  ...
  List<TestDocument> findByValueAndValue2(
      @Param("value") String value, @Param("value2") String value2);
