...
public class CouchDbClient {
     ...
     * document is not annotated with {@link CustomIdGeneration}
     *
     ...
     * both) to the database specified by {@link Document} from the passed entity class. Result is returned as
    ...
    /**
     * Deletes document from database based on {@link Document} annotation of given {@code clazz} with the given id.
     ...
     * query method {@link Index} annotation can be used to specify the index(es).
     *
