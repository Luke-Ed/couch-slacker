...
public enum SchemaOperation {
    ...
    NONE(null, null),
    /**
     * The check that all databases, design documents and views configured in all {@link Document} in scanned
     * packages exists.
     */
    VALIDATE(null, SchemaOperation::validate),
    /**
     * Creates all non-existing databases, design documents and views configured in all {@link Document} in scanned
     * packages. Validation is executed after the creation.
     */
    CREATE(VALIDATE, SchemaOperation::create),
    /**
     * Deletes all existing databases, design documents and views configured in all {@link Document} in scanned
