 ...
 *
 * @param <FirstT>     Type of first parameter consumed
 * @param <SecondT>    Type of the other parameter consumed
 * @param <ExceptionT> Type of {@link Exception} which can be thrown during consummation
 * @author Majlanky
 */
@FunctionalInterface
public interface ThrowingBiConsumer<FirstT, SecondT, ExceptionT extends Exception> {
     ...
     */
    void accept(FirstT first, SecondT theOther) throws ExceptionT;
