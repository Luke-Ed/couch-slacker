...
class CouchDbClientKtTest {
  ...
  @Mock
  private val dbContext: CouchDbContext = mock()
  ...
  @BeforeEach
  fun beforeEach() {
    couchDbClientKt = CouchDbClientKt(httpClient, address, listOf(), 8, 3, false, 10000,
      QueryStrategy.MANGO, ObjectMapper().registerModule(KotlinModule.Builder().build()), dbContext,baseUrl)
  }

  @Test
  fun testSaveNewItem() {
    val mResponseBody: ResponseBody = """{"id": "unique", "rev": "revision", "ok": "true"}""".toResponseBody(
